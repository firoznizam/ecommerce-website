  ...
  return (
    <>
      ...
      {autoPriceNotice && autoPriceNotice.visible && (
        <aside
          aria-label="Daily Mandi Rate Update Notification"
        ...
        >
          ...
          <div className="mt-3 pt-3 border-t border-stone-800 flex items-center justify-between gap-2 text-xs">
            ...
            >
              ...
              <span>Mandi Controls</span>
            </button>
          </div>
        </aside>
      )}

      {/* Floating Mandi Calibration Trigger & Modal (Quick Access) */}
      {showOptions && (
          ...
          <div className="bg-white rounded-3xl p-6 max-w-md w-full shadow-2xl border border-stone-200 space-y-4 animate-in zoom-in-95 duration-200">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-black text-stone-900 text-sm">
                    Kerala Mandi Daily Pricing Engine
                  </h3>
                  <p className="text-[10px] text-stone-500">
                    Automated dawn auction calibration & rate benchmark
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="pt-2 flex items-center justify-end gap-2">
              ...
              >
                ...
                <span>{isRefreshing ? 'Recalibrating Mandi...' : 'Update Daily Prices Now'}</span>
              </button>
            </div>
          </div>
        </div>
